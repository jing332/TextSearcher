...
package com.github.jing332.text_searcher.model.plugin.core.ext

import android.content.Context
import cn.hutool.core.lang.UUID
import com.github.jing332.text_searcher.utils.CharsetUtils
import com.github.jing332.tts_server_android.model.rhino.core.ext.JsNet
...
//        return AudioDecoder.getSampleRateAndMime(audio).first
    ...
    fun getFile(path: String): File {
        ...
        if (!com.github.jing332.text_searcher.utils.FileUtils.exists(cachePath)) File(cachePath).mkdirs()
     ...
     * 获取文件编码
     */
    fun charsetDetect(f: File): String = CharsetUtils.getFileCharsetSimple(f)
    ...
    fun fileExist(path: String): Boolean {
        return com.github.jing332.text_searcher.utils.FileUtils.exists(getFile(path))
    }
